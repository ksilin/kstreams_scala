...
//    }
  ...
  "remove oldest record after TTL expires - tested with MockProcessorContext" in {
    ...
    val transformer: TTLExtractorStoreCleaner[Int, MyRecord] =
      new TTLExtractorStoreCleaner[Int, MyRecord](punctuationInterval, ttl, tsExtractor, storeName)
  ...
  def createTopology(
    ...
    val ttlTransformSupplier: TransformerSupplier[Int, MyRecord, KeyValue[Int, MyRecord]] = () =>
      TTLExtractorStoreCleaner(punctuationInterval, ttl, tsExtractor, storeName)
