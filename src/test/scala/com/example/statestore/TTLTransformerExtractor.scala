...
case class TTLTransformerExtractor[K, V](punctuateInterval: Duration, ttl: lang.Long, timestampExtractor: V => lang.Long, storeName: String,  punctuationType: PunctuationType = PunctuationType.WALL_CLOCK_TIME) extends Transformer[K, V, KeyValue[K, V]] with StrictLogging {
